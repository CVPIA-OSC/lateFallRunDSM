...
adult_stray <- function(wild, natal_flow, south_delta_watershed, cross_channel_gates_closed,
                        ...
                        .intercept = lateFallRunDSM::params$.adult_stray_intercept,
                        .wild = lateFallRunDSM::params$.adult_stray_wild,
                        .natal_flow = lateFallRunDSM::params$.adult_stray_natal_flow,
                        .cross_channel_gates_closed = lateFallRunDSM::params$.adult_stray_cross_channel_gates_closed,
                        .prop_bay_trans = lateFallRunDSM::params$.adult_stray_prop_bay_trans,
                        .prop_delta_trans = lateFallRunDSM::params$.adult_stray_prop_delta_trans){
...
surv_adult_enroute <- function(migratory_temp, bypass_overtopped, adult_harvest,
                               ..surv_adult_enroute_int = lateFallRunDSM::params$..surv_adult_enroute_int,
                               .migratory_temp = lateFallRunDSM::params$.adult_en_route_migratory_temp,
                               .bypass_overtopped = lateFallRunDSM::params$.adult_en_route_bypass_overtopped) {
...
surv_adult_prespawn <- function(deg_day,
                                ..surv_adult_prespawn_int = lateFallRunDSM::params$..surv_adult_prespawn_int,
                                .deg_day = lateFallRunDSM::params$.adult_prespawn_deg_day){
