...
#' @format 1 dimensional array [31 watersheds]
#' @source 
#' Proportion hatchery was derived using coded wire tag analysis. Details and methodology are available \href{https://cvpia-osc.github.io/latefallRunDSM/articles/hatchery-analysis.html}{CVPIA Hatchery Analysis}
"proportion_hatchery"
...
#'   \item \code{spawn_success_fecundity}: Variable describing the number of eggs per female, default value 5522, source: \href{https://www.ucpress.edu/book/9780520227545/inland-fishes-of-california}
#'   \item \code{hatchery_allocation}: More details at \code{\link[lateFallRunDSM]{hatchery_allocation}}
#' }
